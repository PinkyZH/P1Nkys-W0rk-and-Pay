...
class NotificationCenter(QDialog):
    def __init__(self, session_factory: sessionmaker, user_id: int, lang: str = "de", parent=None):
        ...
        self.lang = lang
        self.setWindowTitle(
            t("notif.title", self.lang) if t("notif.title", self.lang) != "notif.title" else "Benachrichtigungen")
    ...
    def _build(self):
        ...
        self.table.setHorizontalHeaderLabels(
            [t("calendar.date", self.lang) if t("calendar.date", self.lang) != "calendar.date" else "Zeit",
        ...
        row = QHBoxLayout()
        btn_ok = QPushButton(
            t("dialogs.common.ok", self.lang) if t("dialogs.common.ok", self.lang) != "dialogs.common.ok" else "OK")
        btn_mark = QPushButton(t("notif.mark_all", self.lang) if t("notif.mark_all",
                                                                   self.lang) != "notif.mark_all" else "Alle als gelesen")
    ...
    def _reload(self):
        ...
        for n in rows:
            ...
            it_time = QTableWidgetItem(fmt_datetime(n.created_at, self.lang));
            it_time.setData(Qt.EditRole, str(n.created_at))
