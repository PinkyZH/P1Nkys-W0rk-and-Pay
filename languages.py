...
LANG = {
    "de": {
        ...
        "calendar": {
            ...
            "date": "Datum", "start": "Beginn", "end": "Ende", "break": "Pause (Min)", "hours": "Stunden",
            "type": "Typ",
        ...
        "admin_users": {
            ...
            "admin.users.reset_pwd": "Passwort zurücksetzen",
            "admin.users.reset_pwd_confirm": "Passwort wirklich zurücksetzen?",
            "admin.users.reset_pwd_default": "ChangeMe123",
            "admin.users.reset_pwd_done": "Passwort zurückgesetzt.",
            "admin.users.select_one": "Bitte zuerst einen Benutzer auswählen.",
            "admin.users.select_any": "Bitte Benutzer auswählen.",
            "admin.users.cant_delete_self": "Der aktuell angemeldete Benutzer kann nicht gelöscht werden.",
            "admin.users.delete_confirm": "Sollen die ausgewählten Benutzer gelöscht werden?",
            ...
            "admin.users.col.locale": "Sprache",
            "admin.users.col.first_name": "Vorname",
            "admin.users.col.last_name": "Nachname",
            "admin.users.col.birthday": "Geburtstag",
            "admin.users.col.phone": "Telefon",
            "admin.users.col.email": "E-Mail",
            "admin.users.col.emp_id": "Mitarbeiter-ID",
            "admin.users.col.employer": "Arbeitgeber",
            "admin.users.col.ahv": "AHV-Nr."
        },
        "payroll": {
        ...
        "profile": {
            ...
            "email": "E-Mail", "phone": "Telefon", "iban": "IBAN", "avatar": "Avatar", "choose_file": "Datei wählen",
            "remove": "Entfernen",
            "bank_name": "Name der Bank", "bank_address": "Adresse der Bank", "bank_zip": "Postleitzahl der Bank",
            "bank_city": "Ort der Bank",
            "bank_country": "Land der Bank", "account_number": "Kontonummer", "show_bank": "Bankdaten anzeigen",
            "employee_id": "Mitarbeiter-ID", "employee_code": "Kürzel", "employer": "Arbeitgeber",
    ...
    "en": {
        "app": {"title": "P1Nky$ W0rk & P@y", "version": "3.3"},
        "login": {"title": "Sign in", "username": "Username", "password": "Password", "language": "Language",
                  "sign_in": "Sign in"},
        "main": {"menu": {
            "account": "Account", "profile": "Profile", "admin": "Admin", "tools": "Tools", "hr": "HR",
            "payroll": "Payroll",
            "account.logout": "Sign out / Switch user…", "account.language": "Language",
            "profile_edit": "Profil bearbeiten"
        }},
        "calendar": {"title": "Calendar", "view_day": "Day", "view_week": "Week", "view_month": "Month",
                     "view_year": "Year",
                     "new_entry": "New", "edit_entry": "Edit", "delete_entry": "Delete", "refresh": "Refresh",
                     "date": "Date", "start": "Start", "end": "End", "break": "Break (min)", "hours": "Hours",
                     "type": "Type",
                     "note": "Note", "location": "Location", "totals": "Totals", "entries": "Entries",
                     "confirm_delete": "Really delete this entry?", "type_filter": "Type filter", "all": "All",
                     "search": "Search note/location",
                     "export_pdf": "Export PDF", "export_xlsx": "Export Excel"
                     },
        "payroll": {"title": "Payroll", "recalc": "Recalculate", "hours_total": "Hours total", "entries": "Entries",
                    "gross": "Gross", "net": "Net", "lock": "Lock", "unlock": "Re-Open",
        ...
        "admin_users": {"title": "User Management", "search": "Search", "username": "Username", "role": "Role",
                        "active": "Active", "last_login": "Last login", "locale": "Language", "name": "Name",
                        "first_name": "First name", "last_name": "Last name", "birthday": "Birthday", "phone": "Phone",
                        "email": "Email", "new": "New", "edit": "Edit", "delete": "Delete", "refresh": "Refresh",
                        "confirm_delete": "Really delete this user?",
                        "cannot_delete_last_admin": "You cannot delete the last ADMIN."},
        "profile": {"title": "My Profile", "save": "Save", "cancel": "Cancel", "gender": "Gender",
                    "first_name": "First name", "last_name": "Last name", "birthday": "Birthday",
                    "civil_status": "Civil status", "permit_status": "Residence status", "locale": "Language",
                    "region_code": "Region/Canton", "address": "Address", "postcode": "Postcode", "city": "City",
                    "email": "Email", "phone": "Phone", "iban": "IBAN", "avatar": "Avatar",
                    "choose_file": "Choose file", "remove": "Remove", "bank_name": "Bank name",
                    "bank_address": "Bank address", "bank_zip": "Bank ZIP", "bank_city": "Bank city",
                    "bank_country": "Bank country", "account_number": "Account number",
                    "show_bank": "Show bank details", "employee_id": "Employee ID", "employee_code": "Short code",
                    "employer": "Employer", "employment_start": "Employment start", "ahv_number": "AHV No.",
                    "hourly_wage": "Hourly wage"},
        "abs": {"status": {"pending": "Pending", "approved": "Approved", "denied": "Rejected"},
                "custom_label": "Custom label"},
    ...
    "sr": {
        "app": {"title": "P1Nky$ W0rk & P@y", "version": "3.3"},
        "login": {"title": "Prijava", "username": "Korisničko ime", "password": "Lozinka", "language": "Jezik",
                  "sign_in": "Prijavi se"},
        "main": {"menu": {
            "account": "Nalog", "profile": "Profil", "admin": "Admin", "tools": "Alati", "hr": "Kadrovi",
            "payroll": "Obračun",
            "account.logout": "Odjavi se / Promeni korisnika…", "account.language": "Jezik",
            "profile_edit": "Profil bearbeiten"
        }},
        "calendar": {"title": "Kalendar", "view_day": "Dan", "view_week": "Nedelja", "view_month": "Mesec",
                     "view_year": "Godina",
                     "new_entry": "Novi", "edit_entry": "Uredi", "delete_entry": "Obriši", "refresh": "Osveži",
                     "date": "Datum", "start": "Početak", "end": "Kraj", "break": "Pauza (min)", "hours": "Sati",
                     "type": "Tip",
                     "note": "Beleška", "location": "Lokacija", "totals": "Zbir", "entries": "Unosa",
                     "confirm_delete": "Zaista obrisati ovaj unos?", "type_filter": "Filter tipa", "all": "Sve",
                     "search": "Pretraga beleške/lokacije",
        ...
        "admin_users": {"title": "Upravljanje korisnicima", "search": "Pretraga", "username": "Korisničko ime",
                        "role": "Uloga", "active": "Aktivan", "last_login": "Poslednja prijava", "locale": "Jezik",
                        "name": "Ime i prezime", "first_name": "Ime", "last_name": "Prezime", "birthday": "Rođendan",
                        "phone": "Telefon", "email": "Email", "new": "Novi", "edit": "Uredi", "delete": "Obriši",
                        "refresh": "Osveži", "confirm_delete": "Zaista obrisati ovog korisnika?",
                        "cannot_delete_last_admin": "Ne možete obrisati poslednjeg ADMIN-a."},
        "profile": {"title": "Moj profil", "save": "Sačuvaj", "cancel": "Otkaži", "gender": "Pol", "first_name": "Ime",
                    "last_name": "Prezime", "birthday": "Rođendan", "civil_status": "Bračni status",
                    "permit_status": "Status boravka", "locale": "Jezik", "region_code": "Region/Kanton",
                    "address": "Adresa", "postcode": "Poštanski broj", "city": "Mesto", "email": "Email",
                    "phone": "Telefon", "iban": "IBAN", "avatar": "Avatar", "choose_file": "Izaberi datoteku",
                    "remove": "Ukloni", "bank_name": "Naziv banke", "bank_address": "Adresa banke",
                    "bank_zip": "Poštanski broj banke", "bank_city": "Grad banke", "bank_country": "Država banke",
                    "account_number": "Broj računa", "show_bank": "Prikaži bankovne podatke",
                    "employee_id": "ID zaposlenog", "employee_code": "Skraćenica", "employer": "Poslodavac",
                    "employment_start": "Datum početka", "ahv_number": "AHV broj", "hourly_wage": "Satnica"},
        "abs": {"status": {"pending": "Na čekanju", "approved": "Odobren", "denied": "Odbijen"},
...
LANG["en"].setdefault("dialogs", {});
LANG["en"]["dialogs"]["common"] = {
...
LANG["en"]["analytics"] = {
    ...
    "export_pdf": "Export Analytics PDF", "export_xlsx": "Export Analytics Excel", "export_png": "Export Analytics PNG",
    "show": "Show analytics"
}
...
LANG["en"]["wprev"] = {
    ...
    "forecast": "Forecast", "this_week": "This week", "next_week": "Next week", "this_month": "This month",
    "next_month": "Next month",
    "extra_hours": "Extra hours (±) / month", "extra_hours_tip": "Added to 174h for what-if monthly value."
}

LANG["sr"].setdefault("dialogs", {});
LANG["sr"]["dialogs"]["common"] = {
...
LANG["sr"]["analytics"] = {
    ...
    "export_pdf": "Izvoz Analytics PDF", "export_xlsx": "Izvoz Analytics Excel", "export_png": "Izvoz Analytics PNG",
    "show": "Prikaži analitiku"
}
...
LANG["sr"]["wprev"] = {
    ...
    "forecast": "Prognoza", "this_week": "Ove nedelje", "next_week": "Sledeće nedelje", "this_month": "Ovaj mesec",
